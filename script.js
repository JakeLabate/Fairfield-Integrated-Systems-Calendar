...
.then(data => {
	data.Projects.forEach(Project => {
		...
		div.innerHTML =
		'<div draggable="true" class="projectCard" style="cursor: pointer;">' +
...
.then(data => {
	data.ServiceOrders.forEach(ServiceOrder => {
		...
		let div = document.createElement('div');
		div.innerHTML =
		'<div draggable="true" class="serviceOrderCard" style="cursor: pointer;">' +
...
.then(data => {
	data.Tasks.forEach(Task => {
		...
		let div = document.createElement('div');
		div.innerHTML =
			'<div draggable="true" class="taskCard" style="cursor: pointer;">' +
